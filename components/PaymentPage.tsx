...
class PaymentPage extends Component<Props,State> {
  ...
  HandleShouldStartLoadWithRequest = (request:any) =>{
    const { url } = request;
    if (url.includes('app.apaylater.com') || url.includes("myboost") || url.includes("shopeemy")) {
      Linking.openURL(url);
      return false;
    }
    return true;
  ...
  render(){
    ...
    let testURL = 'apaylater://app.apaylater.com/entry?q=%3D'
